...
return [
    'client_id'     => getenv('SICMS_GOOGLE_CLIENT_ID') ?: '',
    'client_secret' => getenv('SICMS_GOOGLE_CLIENT_SECRET') ?: '',

    // Leave empty to auto-detect from the current request URL.
    'redirect_uri'  => getenv('SICMS_GOOGLE_REDIRECT_URI') ?: '',

    // Restrict sign-in to CLSU2 email domain.
    'hosted_domain' => getenv('SICMS_GOOGLE_HOSTED_DOMAIN') ?: 'clsu2.edu.ph',
    ...
    'calendar_scopes' => 'https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/gmail.send https://www.googleapis.com/auth/drive.file',
