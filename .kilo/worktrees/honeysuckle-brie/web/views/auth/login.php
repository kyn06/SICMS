    ...
    <div id="termsModal" class="legal-modal" onclick="if(event.target===this)closeModal('termsModal')">
        <div class="legal-modal-content">
            ...
            <div class="legal-modal-body">
                ...
                <p>All content, design, and functionality of DARIS are the property of CLSU and are protected by applicable intellectual property laws.</p>
                <h3>10. Limitation of Liability</h3>
                <p>CLSU and SDRU shall not be held liable for any indirect, incidental, or consequential damages arising from the use of or inability to use DARIS.</p>
                <h3>11. Modifications to Terms</h3>
                <p>SDRU reserves the right to modify these Terms of Service at any time. Continued use of DARIS after changes constitutes acceptance of the modified terms.</p>
                <h3>12. Contact Information</h3>
                <p>For questions or concerns, please contact the Student Discipline and Reformation Unit through the messaging feature in DARIS or visit the SDRU office during business hours.</p>
            </div>
        </div>
    </div>
    ...
    <div id="privacyModal" class="legal-modal" onclick="if(event.target===this)closeModal('privacyModal')">
        <div class="legal-modal-content">
            ...
            <div class="legal-modal-body">
                ...
                <p>The Student Discipline and Reformation Unit (SDRU) of CLSU is committed to protecting the privacy of users of the Discipline and Reformation Information System (DARIS).</p>
                ...
                <h3>7. Your Rights</h3>
                <p>As a user of DARIS, you have the right to access your personal information, request corrections, request account deletion (subject to retention requirements), and receive case status notifications.</p>
                ...
                <p>DARIS is designed for college students 18 years of age or older. We do not knowingly collect personal information from individuals under 18.</p>
                ...
                <p>For questions regarding your personal data or this Privacy Policy, please contact the SDRU through the messaging feature in DARIS or visit the SDRU office.</p>
            </div>
        </div>
    </div>
